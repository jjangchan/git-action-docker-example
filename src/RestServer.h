...
public:
    ...
    void insert_work_call_function(const std::string key, const std::function<void(http_request, std::vector<std::string>&)>& func){
        handler->get_work_call_back_func()[key] = func;
    }
